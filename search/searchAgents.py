...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    """
    # Get corners and walls from problem
    ...
    while len(unvisited) != 0:
        ...
        nextPos = distances[0][1]
        for distance, corner in distances:
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    min_distance = min([util.manhattanDistance(position, f) for f in food])
    return min_distance
